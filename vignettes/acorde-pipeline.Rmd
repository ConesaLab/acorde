...
*NOTE: insert brief parameter description here*

As you can see, half of the isoforms that were initially input for clustering
are currently not assigned to any of the clusters. As a result, we have also
successfully cleaned the signal of our initial set of clusters, and *cluster 6*
now looks like this:
