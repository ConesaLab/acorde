...
see *cluster 1* in `clusters` (`clusters[[2]]`, given that the first element
...
equal to the rest of the members of the cluster. To solve this, we cam use the 
`filter_clusters()` function, which will move isoforms to the unclustered groups 
...
slot. Therefore, *cluster 1* is now `clusters.expanded$expanded[[1]]`:
...
# compare cluster sizes
  ...
  # after expansion
  example_expanded <- clusters.expanded$expanded[[1]]
