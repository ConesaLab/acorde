...
`plot_cluster_ctmeans()`, acorde also includes a two functions that compute and plot 
...
# create grid
plot_grid(plotlist = merged_plots, nrow = 10, 
          labels = seq(1, length(merged_plots)), 
          label_size = 8)
...
### 8.2. Clusters with redundant profiles
